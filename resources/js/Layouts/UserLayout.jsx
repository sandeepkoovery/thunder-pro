...
export default function UserLayout({ children, title = "Dashboard" }) {
  ...
  const renderNav = ({ collapsed, isMobileOpen }) => {
    const modulesList = [
      ...
      { key: 'websites', order: getModuleOrder('websites', 13), element: <NavItem key="websites" href={route("admin.websites.index")} icon={Globe} label="Websites & Domains" routeName="admin.websites" visible={isVisible("websites")} badge={expiringWebsitesCount} collapsed={collapsed} isMobileOpen={isMobileOpen} /> },
