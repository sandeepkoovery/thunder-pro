...
export default function UserLayout({ children, title = "Dashboard" }) {
  ...
  const renderNav = ({ collapsed, isMobileOpen }) => {
    const modulesList = [
      ...
      { key: 'designers_worklist', order: getModuleOrder('designers_worklist', 10), element: <NavItem key="designers_worklist" href={route("designers-worklist.index")} icon={Palette} label="Designers Worklist" routeName="designers-worklist" visible={isVisible("designers_worklist") && isDesignerDepartment} collapsed={collapsed} isMobileOpen={isMobileOpen} /> },
