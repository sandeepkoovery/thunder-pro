    ...
    return (
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 flex flex-col items-center">
            ...
            <div className="w-full space-y-3 mb-8">
                ...
                {status === 'punched_out' && (
                    <div className="w-full py-4 bg-slate-800 text-white font-extrabold rounded-2xl text-center border border-slate-700 shadow-sm flex items-center justify-center gap-2">
